...
Using a pretty minimal grammar (checkout [THE AST](./Parser/ast.h) and [THE GRAMMAR](./Scanner/grammar.md)) it is able to group the files that satisfy the user's query and present it as a directory [...]
